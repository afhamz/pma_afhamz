...
@font-face {
    font-family: 'IcoMoon';
    src: local('☺');
    src: url('./themes/afhamz/fonts/IcoMoon.eot');
    src: url('./themes/afhamz/fonts/IcoMoon.eot?#iefix') format('embedded-opentype'),
        url('./themes/afhamz/fonts/IcoMoon.svg#IcoMoon') format('svg'),
        url('./themes/afhamz/fonts/IcoMoon.woff') format('woff'),
        url('./themes/afhamz/fonts/IcoMoon.ttf') format('truetype');
    font-weight: normal;
    font-style: normal;
}
...
@font-face {
    ...
    src: url('./themes/afhamz/fonts/opensans-regular-webfont.eot');
    src: url('./themes/afhamz/fonts/opensans-regular-webfont.eot?#iefix') format('embedded-opentype'),
        url('./themes/afhamz/fonts/opensans-regular-webfont.woff') format('woff'),
        url('./themes/afhamz/fonts/opensans-regular-webfont.ttf') format('truetype');
    font-weight: normal;
    font-style: normal;
}
...
@font-face {
    ...
    src: url('./themes/afhamz/fonts/opensans-light-webfont.eot');
    src: url('./themes/afhamz/fonts/opensans-light-webfont.eot?#iefix') format('embedded-opentype'),
        url('./themes/afhamz/fonts/opensans-light-webfont.woff') format('woff'),
        url('./themes/afhamz/fonts/opensans-light-webfont.ttf') format('truetype');
    font-weight: normal;
    font-style: normal;
}
...
@font-face {
    ...
    src: url('./themes/afhamz/fonts/opensans-bold-webfont.eot');
    src: url('./themes/afhamz/fonts/opensans-bold-webfont.eot?#iefix') format('embedded-opentype'),
        url('./themes/afhamz/fonts/opensans-bold-webfont.woff') format('woff'),
        url('./themes/afhamz/fonts/opensans-bold-webfont.ttf') format('truetype');
    font-weight: normal;
    font-style: normal;
}
...
@font-face {
    ...
    src: url('./themes/afhamz/fonts/opensans-extrabold-webfont.eot');
    src: url('./themes/afhamz/fonts/opensans-extrabold-webfont.eot?#iefix') format('embedded-opentype'),
        url('./themes/afhamz/fonts/opensans-extrabold-webfont.woff') format('woff'),
        url('./themes/afhamz/fonts/opensans-extrabold-webfont.ttf') format('truetype');
    font-weight: normal;
    font-style: normal;
}
...
.error
{
    border: 1px solid #ebb !important;
    border-radius: 10px;
    color: #222222;
...
{
    background: url('./themes/afhamz/img/s_info.png') !important;
}
